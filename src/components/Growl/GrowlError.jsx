      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="max-w-sm w-full border-2 border-red-200 bg-red-100 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="p-4">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    <p className="text-sm font-medium text-red-700">Notification</p>
